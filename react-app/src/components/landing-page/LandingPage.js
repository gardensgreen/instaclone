		...
		<>
			<div className='landing__container'>
				...
				<div className='main__container'>
					<div className='grid__container'>
						<div className='grid__container-row'>
							...
							/>
							<img className='grid-image' src='https://randomuser.me/api/portraits/men/46.jpg' />
						</div>
						<div className='grid__container-row'>
							<img className='grid-image' src='https://randomuser.me/api/portraits/women/95.jpg' />
							<img
								className='grid-image'
				...
				<div className='footer__container'>
					...
					<a href='https://github.com/gardensgreen/instaclone' className='footer-link'>
