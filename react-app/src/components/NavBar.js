			...
			<div className='nav__div1'>
				<div className='nav__div2'>
					<div className='nav__div2__left'>
						<img src='/images/logo.png' alt='logo' id='navLogo' onClick={e => history.push('/')} />
					</div>
					<div className='nav__div2__center'>
						<input
							className='div2__center__searchbar'
							type='text'
							autoCapitalize='none'
							placeholder='Search'
						/>
							...
							<div id='searchIcons--active'>
								<span
									style={{
										...
										backgroundPosition: '-428px -241px',
										width: '10px',
										height: '10px',
									}}
								>
								...
								<input
									id='searchIcons__input'
									style={{ background: 'transparent', border: 'none', width: '199px' }}
								/>
								<span
									className='searchIcons--searchText'
									style={{
					...
					<div className='nav__div2__right'>
						<div className='div2__right__icons'>
							...
							<div
								onClick={postButton}
								style={{ width: '22px', height: '22px', cursor: 'pointer', marginLeft: '22px' }}
							>
								<svg
									xmlns='http://www.w3.org/2000/svg'
									width='22'
							...
							<div style={{ width: '30px', height: '30px', top: '-2px' }}>
								...
								<div style={{ marginLeft: '-180px', top: '15px', position: 'relative' }}>
									...
									></div>
									<div
										className='center__span__userDropdown'
										style={{
											display: 'none',
									...
									>
										...
										<div className='span__userDropdown__box'>
											<a
												...
												className='userDropdown__box__selections'
