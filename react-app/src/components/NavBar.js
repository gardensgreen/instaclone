...
//   const  [searchInputFocused, setSearchInputFocused] = useState(false);
  ...
  const searchResults = async (e) => {
      const usersFetch = await fetch(`/api/users/search/${e.target.value}`);
      if (!usersFetch.ok) {
          return;
        }
        const { searchResults } = await usersFetch.json();
        setSearchInputResults(searchResults);
  }
        ...
        <div className="nav__div2">
          ...
          <div className="nav__div2__center">
            ...
            <div onClick={clickedSearch} className="div2__center__searchIcons" role="button">
              ...
              <div id="searchIcons--active">
                ...
                <input onChange={searchResults} id="searchIcons__input" value={searchInputResults} style={{ background: "transparent", border: "none", width: "199px" }} />
            ...
            <div className="searchResults__div">
                <div className="searchResults__div-topBox">
                    <div className="box__diamond"></div>
                    <div className="searchResults__div-box">
                        <div className="searchResults__topIndivResults">
          ...
          <div className="nav__div2__right">
            <div className="div2__right__icons">
              ...
              <div onClick={postButton} style={{ width: "22px", height: "22px", cursor: "pointer", marginLeft: "22px" }}>
                <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor" className="bi bi-plus-square" viewBox="0 0 16 16">
                  <path d="M14 1a1 1 0 0 1 1 1v12a1 1 0 0 1-1 1H2a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1h12zM2 0a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2H2z" />
                  <path d="M8 4a.5.5 0 0 1 .5.5v3h3a.5.5 0 0 1 0 1h-3v3a.5.5 0 0 1-1 0v-3h-3a.5.5 0 0 1 0-1h3v-3A.5.5 0 0 1 8 4z" />
                </svg>
              </div>
              <div style={{ width: "30px", height: "30px", top: "-2px" }}>
